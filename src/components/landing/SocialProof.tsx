...
const TESTIMONIALS = [
  ...
  { quote: "I'd tried two prep courses before Karman Prep and nothing stuck. Zakaria nailed my weak spots in the first session. 1090 to 1370 in eight weeks — UVA took me early decision.",                                     name: "Priya S.",     role: "Student, Grade 11", improvement: "+280 pts", tutor: "Zakaria" },
  ...
  { quote: "Karman Prep's diagnostic told me I was overthinking every problem. Zakaria taught me to trust my process. 1080 to 1360. Vanderbilt took me early decision in December.",                                              name: "Zara A.",      role: "Student, Grade 11", improvement: "+280 pts", tutor: "Zakaria" },

  // ── Parents ──────────────────────────────────────────────────
  { quote: "We hired Zakaria after Aisha scored 1020 on her first SAT. Nine weeks later she was at 1340, and Berkeley took her in March. Karman Prep changed her trajectory.",                                                    name: "Yasmin M.",    role: "Parent of Aisha",    improvement: "+320 pts", tutor: "Zakaria" },
  ...
  { quote: "My daughter had tried group classes and apps before. Nothing stuck. Zakaria understood her learning style in the first session. 280 points up and early admission to UVA. I wish we'd found Karman Prep sooner.",     name: "Meera S.",     role: "Parent of Priya",    improvement: "+280 pts", tutor: "Zakaria" },
  ...
  { quote: "We were quoted much higher prices by other companies. Karman Prep offered Zakaria and he exceeded our wildest expectations. 1000 to 1290. Highly recommend.",                                                         name: "Carmen D.",    role: "Parent of Sofia",    improvement: "+290 pts", tutor: "Zakaria" },
  ...
  { quote: "After two years of trying to prep on her own, we found Karman Prep. Zakaria diagnosed the exact issues in two sessions. Six weeks later she had a 290 point improvement — and UT Austin accepted her.",                name: "Chike O.",     role: "Parent of Amara",    improvement: "+290 pts", tutor: "Zakaria" },
  ...
  { quote: "Karman Prep's diagnostic system is remarkable. Zakaria saw patterns in my daughter's answers that three other tutors had missed. 280 points, Vanderbilt ED. The most impactful decision we made her junior year.",     name: "Maryam A.",    role: "Parent of Zara",     improvement: "+280 pts", tutor: "Zakaria" },
];
