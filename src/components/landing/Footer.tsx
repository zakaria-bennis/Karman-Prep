...
const SOCIAL_LINKS = [
  {
    label: "Facebook", href: "https://facebook.com/strataSAT",
    svg: <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>,
  },
  {
    label: "Instagram", href: "https://instagram.com/strataSAT",
  ...
  {
    label: "YouTube", href: "https://youtube.com/@strataSAT",
  ...
  {
    label: "TikTok", href: "https://tiktok.com/@strataSAT",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-10">
          ...
          <div className="col-span-2 md:col-span-1">
            <Link href="/" className="inline-block mb-3" aria-label="Karman home">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              {[["About", "/about"], ["Blog", "/blog"]].map(([label, href]) => (
                <li key={label}>
                  <Link href={href} className="hover:text-white transition-colors">{label}</Link>
                </li>
              ))}
        ...
        <div className="border-t border-slate-800 pt-8 flex flex-col sm:flex-row justify-between items-center gap-3">
          ...
          <p className="text-xs">SAT® is a registered trademark of College Board, which is not affiliated with Karman.</p>
        </div>
      </div>
    </footer>
  );
