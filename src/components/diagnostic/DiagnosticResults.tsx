      ...
      <div className="mx-auto max-w-2xl space-y-6">
                    ...
                    <div className="mb-1 flex items-center justify-between gap-3">
                      ...
                      >
                        {userAnswer
                          ? correct
                            ? "Correct"
                            : `You: ${userAnswer} · Correct: ${q.correct}`
                          : `Skipped · Correct: ${q.correct}`}
                      </span>
                    </div>
                    {q.text && (
        ...
        <div className="rounded-2xl border border-blue-200 bg-blue-50 p-5 text-sm text-blue-700 dark:border-blue-700 dark:bg-blue-900/20 dark:text-blue-300">
          ...
          <p>
            ...
            least 50 points on your next official SAT, we&apos;ll refund your subscription — no
            questions asked.
          </p>
        </div>

        {/* CTA */}
        <Link href={ctaHref} className="btn-primary w-full justify-center py-4 text-base">
          {ctaLabel}
