...
export const metadata: Metadata = {
  title: "Refund Policy — Strata SAT Tutoring",
  description:
    "Strata's refund policy: 7-day trial money-back guarantee and 50-point score improvement guarantee. Full details on how to request a refund.",
};
    ...
    content: (
      <>
        <p className="text-sm text-slate-600 dark:text-slate-300 leading-relaxed mb-3">
          All new Strata subscriptions include a 7-day free trial. You will not be charged during this period. If you cancel before day 8, you owe nothing — ever.
        </p>
        <p className="text-sm text-slate-600 dark:text-slate-300 leading-relaxed mb-3">
        ...
        <p className="text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
          To cancel during your trial: go to <strong>Account → Billing → Cancel Subscription</strong>, or email <a href="mailto:billing@strataSAT.com" className="text-blue-600 dark:text-blue-400 underline">billing@strataSAT.com</a>.
        </p>
      </>
    ),
  },
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p className="text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
          <strong className="text-slate-900 dark:text-white">Refunds</strong> return money already charged. Outside of the 7-day trial window and the 50-point guarantee, Strata does not offer prorated refunds for unused time in a billing period — but we review edge cases individually. Contact us at{" "}
          <a href="mailto:billing@strataSAT.com" className="text-blue-600 dark:text-blue-400 underline">billing@strataSAT.com</a>.
        </p>
      </>
    ),
  },
        ...
        <section className="bg-gradient-to-b from-slate-50 to-white dark:from-slate-900 dark:to-slate-950 pt-20 pb-12 text-center px-4">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-slate-500 dark:text-slate-400 text-base">
              ...
              <a href="mailto:billing@strataSAT.com" className="text-blue-600 dark:text-blue-400 underline">
                billing@strataSAT.com
              </a>
            </p>
          </div>
        </section>
        ...
        <section className="max-w-3xl mx-auto px-4 sm:px-6 py-10 space-y-6">
          ...
          <div className="glass-card p-6">
            ...
            <ol className="space-y-3">
              {[
                "Email billing@strataSAT.com with your account email and the reason for your refund request.",
