...
export const metadata: Metadata = {
  title: "Blog — SAT Tips & Strategy | Strata",
  description:
    "Free SAT study guides, score improvement strategies, test-taking tips, and expert advice from Strata's tutors. Coming soon.",
};
        ...
        <section className="bg-gradient-to-b from-blue-50/80 to-white dark:from-slate-900 dark:to-slate-950 pt-20 pb-16 text-center px-4">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-lg text-slate-600 dark:text-slate-300 leading-relaxed">
              Free SAT study guides, score improvement breakdowns, test-taking strategies, and expert advice — straight from the tutors behind Strata.
            </p>
          </div>
        </section>
