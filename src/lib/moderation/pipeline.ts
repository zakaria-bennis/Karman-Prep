...
const KEYWORD_REJECTION_MESSAGE =
  "This message breaches Strata's terms of use and was not sent. If you believe this is an error, please contact your tutor.";

/** Layer 2 high-severity hold — message is queued for human review. */
const AI_HIGH_REJECTION_MESSAGE =
  "This message breaches Strata's terms of use and is being reviewed by our team. You'll be notified once review is complete.";
